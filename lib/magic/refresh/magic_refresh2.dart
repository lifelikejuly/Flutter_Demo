...
class MagicSliverRefreshControl extends StatefulWidget {
  ...
  @override
  State<MagicSliverRefreshControl> createState() => _MagicSliverRefreshControlState();
}

class _MagicSliverRefreshControlState extends State<MagicSliverRefreshControl> {
