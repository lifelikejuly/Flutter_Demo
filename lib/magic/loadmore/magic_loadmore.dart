...
class _RenderCupertinoSliverRefresh extends RenderSliver
  ...
  void performLayout() {
    ...
    print("<> performLayout layoutExtent $layoutExtent  _hasLayoutExtent $_hasLayoutExtent _refreshIndicatorExtent $_refreshIndicatorExtent layoutExtentOffsetCompensation $layoutExtentOffsetCompensation");
...
class MagicSliverLoadMoreControl extends StatefulWidget {
  ...
  // builder 指示器视图组件构成
  // onRefresh 刷新方法
  const MagicSliverLoadMoreControl({
    Key key,
  ...
  static RefreshIndicatorMode state(BuildContext context) {
    final _MagicSliverRefreshControlState state = context.findAncestorStateOfType<_MagicSliverRefreshControlState>();
  ...
  @override
  State<MagicSliverLoadMoreControl> createState() => _MagicSliverRefreshControlState();
}

class _MagicSliverRefreshControlState extends State<MagicSliverLoadMoreControl> {
