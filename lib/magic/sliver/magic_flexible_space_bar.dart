...
class MagicFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const MagicFlexibleSpaceBar({
    Key key,
    this.title,
    this.background,
    this.centerTitle,
  ...
  @override
  State<MagicFlexibleSpaceBar> createState() => _MagicFlexibleSpaceBarState();
}

class _MagicFlexibleSpaceBarState extends State<MagicFlexibleSpaceBar> {
