...
class UnderLineIndicatorX extends Decoration {
  const UnderLineIndicatorX({
  ...
  @override
  _UnderlinePainterX createBoxPainter([VoidCallback onChanged]) {
    return _UnderlinePainterX(this, onChanged);
  }
}

class _UnderlinePainterX extends BoxPainter {
  _UnderlinePainterX(this.decoration, VoidCallback onChanged)
      : assert(decoration != null),
        super(onChanged);

  final UnderLineIndicatorX decoration;
