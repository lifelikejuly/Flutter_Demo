...
class NoGradientTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _NoGradientTabBarState extends State<NoGradientTabBar> {
  ...
  @override
  void didUpdateWidget(NoGradientTabBar oldWidget) {
