...
//              scale: _scale,
//              child: Text("ssssss",style: TextStyle(color: Colors.brown),),
//            ),
//          )
//        child: Transform.scale(
//          alignment: Alignment.centerLeft,
...
class _TabBarState extends State<CustomTabBar> {
  ...
  Widget _buildStyledTabNew(Widget child, bool selected,
      Animation<double> animation, EdgeInsetsGeometry labelPadding, Key key) {
    return _TabStyleNew(
      animation: animation,
      selected: selected,
      labelColor: widget.labelColor,
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller != null) {
      ...
      if (_controller.indexIsChanging) {
        ...
        wrappedTabs[_currentIndex] = _buildStyledTabNew(
            wrappedTabs[_currentIndex],
            true,
            animation,
            widget.labelPadding,
            widget.key);
        wrappedTabs[previousIndex] = _buildStyledTabNew(
        ...
        wrappedTabs[tabIndex] = _buildStyledTabNew(wrappedTabs[tabIndex], true,
            centerAnimation, widget.labelPadding, widget.key);
        if (_currentIndex > 0) {
          final int tabIndex = _currentIndex - 1;
          final Animation<double> previousAnimation =
              ReverseAnimation(_DragAnimation(_controller, tabIndex));
          wrappedTabs[tabIndex] = _buildStyledTabNew(wrappedTabs[tabIndex],
              false, previousAnimation, widget.labelPadding, widget.key);
        }
        if (_currentIndex < widget.tabs.length - 1) {
          ...
          final Animation<double> nextAnimation =
              ReverseAnimation(_DragAnimation(_controller, tabIndex));
          wrappedTabs[tabIndex] = _buildStyledTabNew(wrappedTabs[tabIndex],
              false, nextAnimation, widget.labelPadding, widget.key);
        }
      }
    }
