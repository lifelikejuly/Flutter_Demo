...
//        : Color.lerp(unselectedColor, selectedColor, animation.value);
    ...
    final double size = ((selected && animation.value < 0.5) ||
        (!selected && animation.value > 0.5))
        ? labelStyle.fontSize
...
class NoGradientTabBarXX extends StatefulWidget implements PreferredSizeWidget {
...
class _NoGradientTabBarState extends State<NoGradientTabBarXX> {
  ...
  @override
  void didUpdateWidget(NoGradientTabBarXX oldWidget) {
