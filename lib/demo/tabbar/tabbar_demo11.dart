...
import 'no_gradient_tabbarx.dart';
import 'under_line_indicatorx.dart';
import 'under_liner_normal.dart';

class TabBarDemo11 extends StatefulWidget {
  @override
  _TabBarDemo1State createState() => _TabBarDemo1State();
}

class _TabBarDemo1State extends State<TabBarDemo11>
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: NoGradientTabBarX(
              indicator: UnderLineIndicatorX(
