...
class ShopScrollCoordinator {
  ...
  /// 当手指离开屏幕
  ///
  double tempPageInitialOffset = 400;
  void onPointerUp(PointerUpEvent event) {
    final double _pagePixels = _pageScrollPosition.pixels;
    if (0.0 < _pagePixels && _pagePixels < tempPageInitialOffset) {
      if (pageExpand == PageExpandState.NotExpand &&
          tempPageInitialOffset - _pagePixels > _scrollRedundancy) {
        _pageScrollPosition
            .animateTo(
              0.0,
