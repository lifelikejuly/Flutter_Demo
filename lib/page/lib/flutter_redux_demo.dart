...
class _ReduxDemoState extends State<FlutterReduxDemo> {
  @override
  void initState() {
    super.initState();
  }
...
//            },
        ...
        StoreConnector<AppState, DemoViewNewModel>(
          converter: DemoViewNewModel.fromStore,
          builder: (context, vm) {
            print("StoreConnector DemoViewNewModel");
            return GestureDetector(child: Text(">>>>> ${vm.change} <<<<<<<<"),
              onTap: (){
...
class DemoViewChangeModel {
  ...
  static DemoViewChangeModel fromStore(Store<AppState> store) {
    print("<> DemoViewChangeModel fromStore");
...
class DemoViewNewModel {
  bool change;

  DemoViewNewModel({this.change});

  static DemoViewNewModel fromStore(Store<AppState> store) {
    return DemoViewNewModel(
      change: false,
    );
  }
