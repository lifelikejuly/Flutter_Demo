...
import 'package:flutter_demo/page/lib/photo_view/src/utils/photo_view_utils.dart';
import 'package:flutter_demo/page/lib/photo_view/src/core/photo_view_gesture_detector.dart';
import 'package:flutter_demo/page/lib/photo_view/src/core/photo_view_hit_corners.dart';
...
class PhotoViewCoreState extends State<PhotoViewCore>
  ...
  void animatePosition(Offset from, Offset to) {
    print("<> animatePosition from ${from.toString()} to ${to.toString()}");
    ...
    return StreamBuilder(
        ...
        builder: (
          ...
          if (snapshot.hasData) {
            ...
            /// 缩放视图上有覆盖件
            if (widget.childPanelList != null && widget.childPanelList.isNotEmpty) {
              child = Stack(
                children: <Widget>[child]..addAll(widget.childPanelList),
              );
            }
