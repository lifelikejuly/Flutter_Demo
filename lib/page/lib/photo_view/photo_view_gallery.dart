...
import 'package:flutter_demo/page/lib/photo_view/photo_view.dart'
    show LoadingBuilder, PhotoView, PhotoViewImageTapDownCallback, PhotoViewImageTapUpCallback, ScaleStateCycle;

import 'package:flutter_demo/page/lib/photo_view/src/controller/photo_view_controller.dart';
import 'package:flutter_demo/page/lib/photo_view/src/controller/photo_view_scalestate_controller.dart';
import 'package:flutter_demo/page/lib/photo_view/src/core/photo_view_gesture_detector.dart';
import 'package:flutter_demo/page/lib/photo_view/src/photo_view_scale_state.dart';
import 'package:flutter_demo/page/lib/photo_view/src/utils/photo_view_hero_attributes.dart';
...
class PhotoViewGallery extends StatefulWidget {
  ...
  const PhotoViewGallery({
    ...
    this.gestureDirection = Axis.vertical,
    this.customSize,
  })  : itemCount = null,
        builder = null,
  ...
  Widget _buildItem(BuildContext context, int index) {
    ...
    final PhotoView photoView = isCustomChild
        ? PhotoView.customChild(
            ...
            childPanelList: pageOption.childPanelList,
...
class PhotoViewGalleryPageOptions {
  ...
  /// child，一些覆盖的元素，Stack包Positioned
  final List<Widget> childPanelList;
